  ...
  return (
    <div className="h-screen mx-10 flex flex-col justify-center items-center">
      <div className="w-auto flex items-center border-teal-300 border-2 p-4 rounded-xl">
        ...
        <button className="bg-teal-600 transition-all text-white hover:bg-white hover:text-teal-600 hover:border-teal-600 hover:border-2 w-32 h-8 px-4 md:ml-4 ml-2 rounded flex flex-row align-middle justify-center content-center text-center items-center">
          Pay Now
        </button>
      </div>
